...
class SimpleAPI {
     ...
     * @throws \Exception
     */
    public static function create($time_start = null): SimpleAPI {
     ...
     * @return $this
     */
    public function addBeforeDestructFunc($func): SimpleAPI {
        if (is_callable($func))
     ...
     * @return $this
     */
    public function addAfterDestructFunc($func): SimpleAPI {
        if (is_callable($func))
     ...
     * @return $this
     */
    public function valid_int(string $field): SimpleAPI {
     ...
     * @return $this
     */
    public function valid_double(string $field): SimpleAPI {
        if (empty($this->data[$field]))
            return $this;
        if (!is_numeric($this->data[$field]))
            $this->error_fields[] = $field;
     ...
     * @return $this
     */
    public function valid_bool(string $field): SimpleAPI {
        if (empty($this->data[$field]))
            return $this;
     ...
     * @return $this
     */
    public function valid_array(string $field): SimpleAPI {
        if (empty($this->data[$field]) || !is_array($this->data[$field]))
            $this->error_fields[] = $field;
        return $this;
    }
     ...
     * @return $this
     */
    public function valid_preg(string $preg, string $field): SimpleAPI {
        if (empty($this->data[$field]))
            return $this;
     ...
     * @return $this
     */
    public function field_invalid(string $field): SimpleAPI {
        $this->error_fields[] = $field;
        return $this;
    }
}
